    ...
    (<div className="container mx-auto p-4">
      ...
      <Tabs defaultValue="grafana" className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="packetAnalyzer">Packet Analyzer</TabsTrigger>
        ...
        <TabsContent value="grafana" className="mt-4">
          <Card>
            ...
            <CardContent className="h-[calc(100vh-300px)] min-h-[500px]">
              <iframe
                src={"http://127.0.0.1:3001/d/app/netprobe?orgId=1&from=now-30m&to=now&timezone=browser"}
                width="100%"
                height="100%"
                frameBorder="0"
        ...
        <TabsContent value="packetAnalyzer" className="mt-4">
          <PacketAnalyzer />
        </TabsContent>
